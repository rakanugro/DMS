                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Form Jenis Dokumen</h5>
                                                <form action ="/dokumen/store" method="post" class="">
                                                    {{ csrf_field() }}
                                                    <div class="position-relative form-group"><label for="exampleEmail" class="">Jenis dokumen</label><input name="jenis_dokumen" id="jenis_dokumen" placeholder="dokumen" type="text" class="form-control" required=""></div>
                                                    <div class="position-relative form-group"><label  class="">Ket dokumen</label><input name="ket" id="ket" placeholder="keterangan" type="text"
                                         ...
                                         <div class="row">
                                                 <div class="col-md-12">
                                                    <div class="main-card mb-3 card">
                                                    <h5 class="mt-4 mb-4"> Jenis Dokumen</h2>
                                                            <table id="data_produsen" class="display" style="width:100%">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>    
                                                                            ...
                                                                            <td>
                                                                                <a href="/dokumen/edit/{{ $item->no_id }}" class="btn btn-primary" ><i class="fa fa-edit"></i> EDIT </a>
                                                                                <a href="/dokumen/delete/{{ $item->no_id }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> DEL </a>
                                                                            </td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
