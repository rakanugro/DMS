                        ...
                        <div class="row">
                             ...
                             <div class="col-md-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Edit Produsen</h5>
                                                
                                                <form action ="/produsen/update" method="post" class="">
                                                    {{ csrf_field() }}
                                                    @foreach($produsen as $item)
                                                    <input type="hidden" name="no_id" id="no_id" value="{{ $item->no_id }}">
                                                    <div class="position-relative form-group"><label for="exampleEmail" class="">Nama Produsen</label><input name="nama_produsen" id="nama_produsen" placeholder="produsen" type="text" class="form-control" required="" value="{{ $item->nama_produsen }}"></div>
                                                    ...
                                                    class="form-control" value="{{ $item->alamat_produsen }}"></div>
                                                    ...
                                                    class="form-control" value="{{ $item->telepon }}"></div>
