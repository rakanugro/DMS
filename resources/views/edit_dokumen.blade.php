                            ...
                            <div class="col-md-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Form Jenis Dokumen</h5>
                                                <form action ="/dokumen/update" method="post" class="">
                                                    {{ csrf_field() }}
                                                    @foreach($dokumen as $item)
                                                    <input type="hidden" name="no_id" id="no_id" value="{{ $item->no_id }}">
                                                    <div class="position-relative form-group"><label for="exampleEmail" class="">Jenis dokumen</label><input name="jenis_dokumen" id="jenis_dokumen" placeholder="dokumen" type="text" class="form-control" required="" value="{{ $item->jenis_dokumen }}"></div>
                                                    <div class="position-relative form-group"><label for="examplePassword" class="">Ket dokumen</label><input name="ket" id="ket" placeholder="keterangan" type="text"
